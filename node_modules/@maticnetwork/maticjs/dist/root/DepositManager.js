...
var DepositManager = /** @class */ (function (_super) {
    ...
    function DepositManager(depositManager, web3Client, registry) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.childChainContract = new this.web3Client.web3.eth.Contract(ChildChain_json_1.default.abi, childChainAddress);
                        return [2 /*return*/];
                }
            });
        });
